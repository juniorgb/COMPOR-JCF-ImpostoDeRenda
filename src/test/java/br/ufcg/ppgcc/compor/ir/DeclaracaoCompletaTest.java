...
public class DeclaracaoCompletaTest {
	...
	public void T_04_06_calculoImpostoIsentoComDependente() {
		...
		cadastrarCalcularImpostoDevido(0, titular1, 1000, dependente1, dependente1);

		Titular titular2 = TitularHelper.criarTitularPadrao2();
		Dependente dependente2 = DependenteHelper.criarDependentePadrao2();
		cadastrarCalcularImpostoDevido(0, titular2, 15000, dependente2, dependente2);

		Titular titular3 = TitularHelper.criarTitularMinimo();
		Dependente dependente3 = DependenteHelper.criarDependentePadrao1();
		Dependente dependente4 = DependenteHelper.criarDependentePadrao1();
	...
	public void T_04_07_calculoImpostoFaixa2ComDependente() {
		Titular titular1 = TitularHelper.criarTitularPadrao();
		Dependente dependente1 = DependenteHelper.criarDependentePadrao1();
		novocadastrarCalcularImpostoDevido(0, titular1, 20000, dependente1);

		Titular titular2 = TitularHelper.criarTitularPadrao2();
		Dependente dependente2 = DependenteHelper.criarDependentePadrao2();
		novocadastrarCalcularImpostoDevido(253.49, titular2, 25000, dependente2);
	...
	public void T_04_08_calculoImpostoFaixa3ComDependente() {
		Titular titular1 = TitularHelper.criarTitularPadrao();
		Dependente dependente1 = DependenteHelper.criarDependentePadrao1();
		novocadastrarCalcularImpostoDevido(628.49, titular1, 30000, dependente1);

		Titular titular2 = TitularHelper.criarTitularPadrao2();
		Dependente dependente2 = DependenteHelper.criarDependentePadrao2();
		novocadastrarCalcularImpostoDevido(1272.24, titular2, 35000, dependente2);
	...
	private void cadastrarCalcularImpostoDevido(double d, Titular titular3,
			int i, Dependente dependente3, Dependente dependente4) {
	...
	public void T_04_09_calculoImpostoFaixa4ComDependente() {
		Titular titular1 = TitularHelper.criarTitularPadrao();
		Dependente dependente1 = DependenteHelper.criarDependentePadrao1();
		cadastrarCalcularImpostoDevido(2022.24, titular1, 40000, dependente1, dependente1);

		Titular titular2 = TitularHelper.criarTitularPadrao2();
		Dependente dependente2 = DependenteHelper.criarDependentePadrao2();
		cadastrarCalcularImpostoDevido(3054.89, titular2, 45000, dependente2, dependente2);
	...
	public void T_04_10_calculoImpostoFaixa5ComDependente() {
		...
		cadastrarCalcularImpostoDevido(4404.89, titular1, 51000, dependente1, dependente1);

		Titular titular2 = TitularHelper.criarTitularPadrao2();
		Dependente dependente2 = DependenteHelper.criarDependentePadrao2();
		cadastrarCalcularImpostoDevido(17878.57, titular2, 100000, dependente2, dependente2);
